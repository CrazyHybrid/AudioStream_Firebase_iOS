...
class SideViewController: UIViewController, LeftMenuProtocol {
    ...
    var menus = ["Recent", "Category", "Record", "Profile", "Notification"]
    ...
    override func viewDidLoad() {
        ...
        let swiftViewController = storyboard.instantiateViewController(withIdentifier: "categoryVC") as! CategoryVC
        self.swiftViewController = UINavigationController(rootViewController: swiftViewController)
        
        let javaViewController = storyboard.instantiateViewController(withIdentifier: "recordVC") as! RecordVC
